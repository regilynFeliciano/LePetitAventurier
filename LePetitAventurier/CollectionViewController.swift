...
//        collectionView = UICollectionView(frame: CGRectMake(275, 200, 600, 550), collectionViewLayout: layout)
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        if indexPath.section == 0 {
            if indexPath.row == 0 {
                ...
                dateCell.backgroundColor = UIColor.grayColor()
                ...
                if indexPath.section == 0 {
                    contentCell.backgroundColor = UIColor.grayColor()
